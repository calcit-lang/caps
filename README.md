...
| --- | --- | --- | --- | --- |
| `0.1.0-rc.2` | exact `0.13.72` | exact `0.13.72` when present | C-safe ABI v1, verified with `calcit_native_ffi 0.1.3` and default features disabled | Candidate target; publish and Calcium Workflow/Respo smoke pending / 候选目标，等待发布与真实项目 smoke |
